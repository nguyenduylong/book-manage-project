...
import static panelitem.PublishingCompanyItemPanel.list;
import static panelitem.PublishingCompanyItemPanel.listSearch;
import static panelitem.PublishingCompanyItemPanel.pos;
...
public class TypeItemPanel extends javax.swing.JPanel {
        static Client client;
        static int pos;
        MyCanvas canvas ;
    //CONNECT DB
        String DBColumn = "TenTheLoai";
        String DBName = "TheLoai";
        String DBSach = "Sach";
    ...
    public TypeItemPanel(Dimension dimension,Client client) {
        this.dimension = dimension;
        this.client = client;
        int width = dimension.width;
        int height = dimension.height;
        list.clear();
        initComponents();labelSearch.setText("Nhập Thể Loại");
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                Thread x = new Thread(){
                    ...
                    public void run() {
                        ...
                        client.SEND("select * from \"Sach\" natural join \"Sach_TheLoai\" natural join \"TheLoai\" where \"TenTheLoai\" = '"+tacgia+"'");
