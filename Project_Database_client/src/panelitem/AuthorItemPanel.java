...
public class AuthorItemPanel extends javax.swing.JPanel {
        int pos;
    //DATA
    ...
    //PARENT PANEL
        JPanel panelParent = new JPanel(null);
        //PARENT PANEL CHILD
    ...
    public AuthorItemPanel(Dimension dimension,Client client) {
        this.dimension = dimension;
        this.client = client;
        int width = dimension.width;
        int height = dimension.height;
        list.clear();
        initComponents();labelSearch.setText("Nhập Tác Giả");
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                Thread x = new Thread(){
                    ...
                    public void run() {
                        ...
                        client.SEND("select * from \"Sach\" where \"TenTacGia\" = '"+tacgia+"'");
